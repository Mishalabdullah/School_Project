...
def check_Tick(): # The Funciton is for changing the colour of the boxes
    ...
    for i in l:
        ...
        if i[0] == 1:
            if i [1] == 1:
                canvas = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 2:
            if i[1] == 1:
                canvas2 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 3:
            if i [1] == 1:    
                canvas3 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 4:
            if i[1] == 1:
                    canvas4 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 5:
            if i[1] ==1:
                canvas5 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 6:
            if i[1] ==1:
                canvas6 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 7:
            if i[1] ==1:        
                canvas7 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 8:
            if i[1] ==1:
                canvas8 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 9:
            if i[1] ==1:
                canvas9 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 10:
            if i[1] ==1:
                canvas10 = Canvas(frm,width=50,height=100)
                canvas10.create_rectangle(50, 50,10, 10, fill="#f50")
                canvas10.grid(column=1,row=5)
            else:
                canvas11 = Canvas(frm,width=50,height=100)
        ...
        if i[0] == 12:
            if i[1] ==1:
                canvas12 = Canvas(frm,width=50,height=100)
